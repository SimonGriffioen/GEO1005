...
<qgis version="2.10.1-Pisa" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="BU_NAAM" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="Banne Buiksloot" label="Banne Buiksloot"/>
      <category render="true" symbol="1" value="Buiksloterham" label="Buiksloterham"/>
      <category render="true" symbol="2" value="Buikslotermeer" label="Buikslotermeer"/>
      <category render="true" symbol="3" value="Ijplein/Vogelbuurt" label="Ijplein/Vogelbuurt"/>
      <category render="true" symbol="4" value="Kadoelen" label="Kadoelen"/>
      <category render="true" symbol="5" value="Nieuwendammerdijk/Buiksloterdijk" label="Nieuwendammerdijk/Buiksloterdijk"/>
      <category render="true" symbol="6" value="Nieuwendammerham" label="Nieuwendammerham"/>
      <category render="true" symbol="7" value="Nieuwendam-Noord" label="Nieuwendam-Noord"/>
      <category render="true" symbol="8" value="Oostzanerwerf" label="Oostzanerwerf"/>
      <category render="true" symbol="9" value="Tuindorp Buiksloot" label="Tuindorp Buiksloot"/>
      <category render="true" symbol="10" value="Tuindorp Nieuwendam" label="Tuindorp Nieuwendam"/>
      <category render="true" symbol="11" value="Tuindorp Oostzaan" label="Tuindorp Oostzaan"/>
      <category render="true" symbol="12" value="Volewijck" label="Volewijck"/>
      <category render="true" symbol="13" value="Waterland" label="Waterland"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="BU_NAAM"/>
    <property key="labeling/fontBold" value="false"/>
    <property key="labeling/fontCapitals" value="0"/>
    <property key="labeling/fontFamily" value="Berlin Sans FB"/>
  ...
  <layerTransparency>86</layerTransparency>
  <displayfield>P_GESCHEID</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <editform>./Layers QGIS - pascal</editform>
  <editforminit/>
  <featformsuppress>0</featformsuppress>
  <annotationform>./Layers QGIS - pascal</annotationform>
