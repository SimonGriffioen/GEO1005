...
<qgis version="2.10.1-Pisa" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="TYPE" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="Cycleway, footpath, etc." label="Cycleway, footpath, etc."/>
      <category render="true" symbol="1" value="Motorway link" label="Motorway link"/>
      <category render="true" symbol="2" value="Motorway or highway" label="Motorway or highway"/>
      <category render="true" symbol="3" value="Primary link" label="Primary link"/>
      <category render="true" symbol="4" value="Primary road" label="Primary road"/>
      <category render="true" symbol="5" value="Road, residential, living street, etc." label="Road, residential, living street, etc."/>
      <category render="true" symbol="6" value="Secondary" label="Secondary"/>
      <category render="true" symbol="7" value="Secondary link" label="Secondary link"/>
      <category render="true" symbol="8" value="Tertiary" label="Tertiary"/>
      <category render="true" symbol="9" value="Track" label="Track"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="167,114,117,255"/>
          <prop k="line_style" v="solid"/>
